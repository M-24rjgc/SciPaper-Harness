...
| [research.md](research.md) | the research ledger: `ResearchProject` with its mode and autonomy, the report-only `research_check` phases and checks, the only refusals, and slow work kept outside the per-project queue |
