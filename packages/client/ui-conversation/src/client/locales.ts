...
export const zh = {
  ...
  'placeholder.hero': '说说你的研究问题，或把论文、数据拖进来, / 调用指令, @ 文件或对话',
...
export const en = {
  ...
  'placeholder.hero': 'Describe your research question, or drop in papers and data, / commands, @ files or sessions',
  ...
  'hero.headline': 'Start a piece of research',
