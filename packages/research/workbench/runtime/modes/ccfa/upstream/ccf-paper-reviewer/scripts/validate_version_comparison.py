...
# [research-workbench] the mode pack keeps the skill's references under skills/, beside upstream/.
if not REFERENCES.is_dir():
    REFERENCES = Path(__file__).resolve().parents[3] / "skills" / "ccf-paper-reviewer" / "references"
