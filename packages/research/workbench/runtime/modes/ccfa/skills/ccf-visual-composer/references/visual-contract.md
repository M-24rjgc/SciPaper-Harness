...
- Record reference roles, measured geometric relationships, and origin. Apply the requested layout relationships to the supplied science; preserve an explicitly supplied template when requested. Do not transplant unrelated labels, scientific claims, or artwork.
