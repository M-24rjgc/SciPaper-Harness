...
6. Preserve necessary reusable source and assets. Record origin and element semantics in the existing source/specification; a separate manifest or element map is needed only when requested or required by a converter/package.
