...
Do not add SHA-256, checksum files, hashes, or hash-based identity as generic writing, deduplication, origin, or confirmation requirements. Use method names, versions, configurations, dataset splits, checkpoint labels, and repository revisions when relevant.
