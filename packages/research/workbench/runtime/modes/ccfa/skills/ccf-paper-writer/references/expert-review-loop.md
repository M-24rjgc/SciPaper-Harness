...
Formal issue origin, historical/current score deltas, and the canonical revision ledger remain with `ccf-paper-reviewer` and `ccf-rebuttal-writer`. Do not create writer-owned review scores or per-pass critique files.
