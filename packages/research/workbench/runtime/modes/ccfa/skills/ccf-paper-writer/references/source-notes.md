...
Use this file only when source origin matters, when updating venue assumptions, or when explaining where exemplar records came from.
...
- Use source records only for origin, venue-policy checks, exemplar source tracking, and update auditing.
