...
| Design experiments | Designer establishes claims, method, baseline origin, metrics, and data compatibility. Searcher fills missing external evidence; reviewer can challenge a consequential claim-to-test mismatch. Plans and expected results remain distinct from observations. |
