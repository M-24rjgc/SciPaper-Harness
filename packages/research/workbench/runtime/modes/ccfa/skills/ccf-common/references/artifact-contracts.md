...
| Required icon/reference assets | `assets/<semantic-name>.<ext>` | Reuse across iterations; retain origin in the source/specification. Do not duplicate the same asset per format. |
